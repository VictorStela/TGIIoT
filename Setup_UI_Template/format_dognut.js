...
var doughnut1 = [totaltimeNaoApontada,totaltimeScheduledStop,totaltimeUnscheduledStop,0,0,0,0];
var doughnut2 = [0,0,0,totaltimeSetup,totaltimeManutProd,totaltimeRefeicao,totaltimeManutPlan];

var type = 'doughnut';
var labels = ['Parada não apontada','Parada não planejada','Parada planejada','Setup','Ajuste / Regulagem','Refeição','Manutenção Planejada'];
var datasets = [{
    'type': 'doughnut',
    'label': 'Paradas',
    'data': doughnut1,
    'backgroundColor': ['rgba(255, 59, 59, 0.5)','rgba(255, 229, 59, 0.5)','rgba(107, 255, 38, 0.5)','rgba(38, 255, 204, 0.5)','rgba(38, 42, 255, 0.5)','rgba(208, 38, 255, 0.5)','rgba(255, 38, 125, 0.5)'],
    'borderColor': ['rgba(255, 59, 59, 1)','rgba(255, 229, 59, 1)','rgba(107, 255, 38, 1)','rgba(38, 255, 204, 1)','rgba(38, 42, 255, 1)','rgba(208, 38, 255, 1)','rgba(255, 38, 125, 1)'],
    'borderWidth': 1,
    'hoverBackgroundColor': ['rgba(255, 59, 59, 1)','rgba(255, 229, 59, 1)','rgba(107, 255, 38, 1)','rgba(38, 255, 204, 1)','rgba(38, 42, 255, 1)','rgba(208, 38, 255, 1)','rgba(255, 38, 125, 1)']
},{
    'type': 'doughnut',
    'label': 'Paradas',
    'data': doughnut2,
